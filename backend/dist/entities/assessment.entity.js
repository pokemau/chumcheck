...
const startup_response_entity_1 = require("./startup-response.entity");
...
let Assessment = class Assessment {
    ...
    description;
    answerType;
    responses = new core_1.Collection(this);
};
...
__decorate([
    (0, core_1.Enum)(() => assessment_util_enum_1.AssessmentAnswerType),
    __metadata("design:type", Number)
], Assessment.prototype, "answerType", void 0);
__decorate([
    (0, core_1.OneToMany)(() => startup_response_entity_1.StartupResponse, r => r.assessment),
    __metadata("design:type", Object)
], Assessment.prototype, "responses", void 0);
exports.Assessment = Assessment = __decorate([
    (0, core_1.Entity)({ tableName: "assessments" })
], Assessment);
