...
export class Migration20250428202209 extends Migration {
  override async up(): Promise<void> {
    this.addSql(
      `create table "urat_question_answers" ("id" serial primary key, "response" varchar(255) not null, "score" int not null default 1, "startup_id" int not null, "urat_question_id" int not null);`,
    );
